---
title: 'Zero Bandwidth on Origin: Serving API Responses via Signed URL Redirects'
...
- **Responses are large** (>10KB) — the bandwidth savings are proportional to response size
...
- **Responses are tiny** (<1KB) — the redirect overhead exceeds the proxy cost
